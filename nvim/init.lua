...
require('lazy').setup({
  ...
  'tpope/vim-sleuth',   --Tabstop and indent
...
vim.cmd [[let g:python3_host_prog = "/home/ge/.venv/generalPython/bin/python3"]]
...
vim.keymap.set('n', '<leader>cv', "<cmd>lua require('swenv.api').pick_venv()<cr>", { desc = "Choose Env"})
